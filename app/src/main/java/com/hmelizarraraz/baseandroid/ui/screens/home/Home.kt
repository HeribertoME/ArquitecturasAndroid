...
import com.hmelizarraraz.baseandroid.data.local.MoviesDao
import com.hmelizarraraz.baseandroid.data.remote.ServerMovie
...
fun Home(moviesRepository: MoviesRepository) {
    ArquitecturasAndroidTheme {
        ...
        val viewModel: HomeViewModel = viewModel { HomeViewModel(moviesRepository) } // Para compose
